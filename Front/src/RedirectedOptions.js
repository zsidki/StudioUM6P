...
const CardComponent = ({ logo, name, description, website, email, phone, location, excelFile }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-md mx-auto transition-transform duration-300 hover:shadow-xl">
      {/* Full-width logo */}
      ...
      <div className="p-6">
        ...
        {/* Business Information with Grey Icons */}
  ...
  const agencies = [
    {
      ...
      excelFile: '/Excel/Bordereau_de_Prix-109_Agency.xlsx',
    },
    {
      ...
      excelFile: '/Excel/Bordereau_de_Prix-Bulls_and_Lions.xlsx',
    }
  ];

  return (
    <div className="p-10 bg-gray-50 min-h-screen">
      <h1 className="text-center text-4xl font-bold mb-10 text-gray-800">Redirected Options</h1>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        {agencies.map((agency, index) => (
          <CardComponent key={index} {...agency} />
        ))}
      </div>
    </div>
  );
