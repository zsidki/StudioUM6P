...
public class UserService {
    ...
    // Register a new user
    public User registerUser(String username, String email, String password, String department, String phone) {
    ...
    private boolean isValidEmail(String email) {
        return email.endsWith("@um6p.ma") || email.endsWith("@esi.ac.ma");
    }
}
